...
public class Constants {
    ...
    public static final String CHROMEDRIVER_PATH_MAC = DRIVERPATH + FILE_SEPARATOR + "chromedriver_mac64/chromedriver.exe";
    public static final String CHROMEDRIVER_PATH_LIN = DRIVERPATH + FILE_SEPARATOR + "chromedriver_linux64/chromedriver.exe";
